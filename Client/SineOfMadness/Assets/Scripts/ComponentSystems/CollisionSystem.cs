...
public class CollisionSystem : JobComponentSystem
{
	...
	{
		playerGroup = GetEntityQuery(typeof(Health), ComponentType.ReadOnly<Translation>(), ComponentType.ReadOnly<Player>());
		enemyGroup = GetEntityQuery(typeof(Health), ComponentType.ReadOnly<Translation>(), ComponentType.ReadOnly<Enemy>());
		bulletGroup = GetEntityQuery(typeof(BulletTag), ComponentType.ReadOnly<Translation>());
	}
